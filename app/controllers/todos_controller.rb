...
class TodosController < ApplicationController
  ...
  def create
   ...
   # test = todo_params.to_hash
  #test.each do |param|
  #     puts param.class
  #     puts "Key: #{param[0]}, Value: #{param[1]}"
    
    # end
    
    #jparams = JSON.parse(todo_params)
    #todo_params = todo_params.to_hash
   
    #u.save!
    #u.mapping_file.url # => '/url/to/file.png'
    #u.mapping_file.current_path # => 'path/to/file.png'
    #u.mapping_file_identifier # => 'file.png'
